...
#import "AVPlayerLocalVideoControlller.h"
#import "Const.h"

@interface AVPlayerLocalVideoControlller ()
...
@implementation AVPlayerLocalVideoControlller
...
-(AVPlayerLayer *)playerLayer
{
    if(_playerItem == nil)
    {
        _playerItem                  = [[AVPlayerItem alloc]initWithURL:[NSURL fileURLWithPath:[[NSBundle mainBundle]pathForResource:@"popeye" ofType:@".mp4"]]];
